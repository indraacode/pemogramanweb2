...
<div class="container">
    ...
    <table>
        ...
        <tr>
            ...
            <td class="right"><?php echo number_format($harga1); ?></td>
            <td class="right"><?php echo number_format($th1); ?></td>
        </tr>

        <tr>
            <td><?php echo $brg2; ?></td>
            <td class="right"><?php echo $jmlbrg2; ?></td>
            <td class="right"><?php echo number_format($harga2); ?></td>
            <td class="right"><?php echo number_format($th2); ?></td>
        </tr>

        <tr>
            <td><?php echo $brg3; ?></td>
            <td class="right"><?php echo $jmlbrg3; ?></td>
            <td class="right"><?php echo number_format($harga3); ?></td>
            <td class="right"><?php echo number_format($th3); ?></td>
        </tr>

        <tr>
            <td><?php echo $brg4; ?></td>
            <td class="right"><?php echo $jmlbrg4; ?></td>
            <td class="right"><?php echo number_format($harga4); ?></td>
            <td class="right"><?php echo number_format($th4); ?></td>
        </tr>
